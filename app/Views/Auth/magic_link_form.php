...
<body>
                            ...
                            <div class="row justify-content-center g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <p class="text-muted">Reset password with Vibe</p>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Wait, I remember my password... <a href="<?= url_to('login') ?>" class="fw-semibold text-primary text-decoration-underline"> Click here </a> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="<?= base_url('assets/velzone/assets/js/pages/plugins/lord-icon-2.1.0.js') ?>"></script>
